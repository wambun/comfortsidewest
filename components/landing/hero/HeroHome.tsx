...
import { ArrowRight, CheckCircle, Snowflake, ThermometerSun } from 'lucide-react';
import { useRef } from 'react';

const features = [
  'Premium Ductless HVAC Systems',
  'Exclusive Dealer Programs',
  'Fast Shipping Across the West',
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-display font-semibold tracking-headline text-primary mb-6 leading-tight">
              ...
              <br />
              <span className="text-primary/70">Systems for Dealers</span>
            </h1>

            {/* Description */}
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0">
              Partner with Comfortside West for top-tier mini-split systems from Cooper&Hunter,
              Olmo, and Bravo. Competitive pricing, fast delivery, and dedicated dealer support.
            </p>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-card">
                <Image
                  ...
                  alt="HVAC warehouse and distribution"
                  width={1200}
                  height={800}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-foreground/80 italic mb-2">
                      "Best wholesale partner we've worked with. Fast shipping and great support!"
                    </p>
                    <p className="text-xs text-muted-foreground">John Martinez, HVAC Contractor</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground">Energy Star</div>
